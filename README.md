...
**阵营胜率 6 轮收敛** —— 蜀、吴双双逼近 50% 平衡线，阵营差 65.3% → 5.6%：

![阵营胜率收敛曲线](docs/balance/convergence.png)

**单卡净胜率影响（netImpact）** —— 据此精准定位最强 / 最弱的少数卡再微调，而非大改：

![单卡净胜率影响](docs/balance/card-impact.png)

**回合数分布** —— 平均 13.4 回合、峰值 T16、无疲劳致死，对局节奏健康：

![回合数分布](docs/balance/turn-distribution.png)
